 ...
 * @description：滚动滑动样式的侧滑Item
 **/
@OptIn(ExperimentalFoundationApi::class)
@Composable
fun ScrollMotionSwipe() {
      ...
      val state = remember {
            AnchoredDraggableState(
                  ...
                  positionalThreshold = { distance: Float -> distance * 0.5f },//位置
                  ...
                  Box(
                        ...
                        ActionView(
                              ...
                              modifier = Modifier
                                    ...
                                    .offset {
                                          IntOffset(
                                                x = ((-state.requireOffset() - startActionSizePx)).roundToInt(),
                                                y = 0
                                          )
                                    }
                        )
            ...
            endAction = {
                  Row(
                        modifier = Modifier
                              ...
                              .offset {
                                    IntOffset(
                                          x = (- state.requireOffset() + endActionSizePx).roundToInt(),
                                          y = 0
                                    )
                              } ,
                  ) {
