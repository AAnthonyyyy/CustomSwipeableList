...
fun DrawerMotionSwipe() {
      ...
      val state = remember {
            AnchoredDraggableState(
                  ...
                  positionalThreshold = { distance: Float -> distance * 0.5f },//定义位置阈值
                  velocityThreshold = { with(density) { 50.dp.toPx() } },//定义速度阈值
                  ...
                  Box(
                        ...
                        ActionView(
                              ...
                              modifier = Modifier
                                    ...
                                    .offset {
                                          IntOffset(
                                                x = ((-state.requireOffset() - actionSizePx)).roundToInt(),
                                                y = 0
                                          )
                                    }
                        )
